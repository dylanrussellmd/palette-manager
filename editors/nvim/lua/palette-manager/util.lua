...
Color utility functions — blend/darken/lighten for deriving non-base16
color shades at runtime. Used by colors.lua to compute derived colors
(bg_d, contrast, diff_*, etc.) from the 16 base16 colors.
]]
